        ...
        public class MenuTextFile
        {
            ...
            public static List<ItemProperties> GetMenu(string path)
            {
                ...
                while (line != null)
                {
                    ...
                    itemProperties.Add(new ItemProperties (itemproperties[0], double.Parse(itemproperties[1]), itemproperties[2], itemproperties[3], itemproperties[4], double.Parse(itemproperties[5]), double.Parse(itemproperties[6])));
